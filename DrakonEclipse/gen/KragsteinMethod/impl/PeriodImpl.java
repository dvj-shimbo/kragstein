 ...
 * <ul>
 *   <li>{@link KragsteinMethod.impl.PeriodImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PeriodImpl extends MinimalEObjectImpl.Container implements Period {
	...
	protected EClass eStaticClass() {
		return KragsteinMethodPackage.Literals.PERIOD;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinMethodPackage.PERIOD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KragsteinMethodPackage.PERIOD__VALUE:
				return getValue();
		}
