 ...
 * @generated
 */
public class IconConnection2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IconConnection2ReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof KragsteinMethod.IconConnection) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return KragsteinMethod.diagram.edit.policies.KragsteinMethodBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistIconConnection_4004(container,
	 ...
	 * @generated
	 */
	protected KragsteinMethod.IconConnection getLink() {
		return (KragsteinMethod.IconConnection) getElementToEdit();
	}
