...
public class ActionEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.ActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinMethod.diagram.edit.parts.ActionNameEditPart) {
			((KragsteinMethod.diagram.edit.parts.ActionNameEditPart) childEditPart)
