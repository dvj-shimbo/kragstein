 ...
 * @generated
 */
public class Route3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Route3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.Route3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinMethod.diagram.edit.parts.RouteRouteIconCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getRouteIconCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((KragsteinMethod.diagram.edit.parts.RouteRouteIconCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinMethod.diagram.edit.parts.RouteRouteIconCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getRouteIconCompartmentFigure();
			pane.remove(((KragsteinMethod.diagram.edit.parts.RouteRouteIconCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof KragsteinMethod.diagram.edit.parts.RouteRouteIconCompartment3EditPart) {
