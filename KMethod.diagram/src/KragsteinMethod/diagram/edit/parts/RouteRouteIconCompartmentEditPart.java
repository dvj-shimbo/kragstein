 ...
 * @generated
 */
public class RouteRouteIconCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public RouteRouteIconCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return KragsteinMethod.diagram.part.Messages.RouteRouteIconCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.RouteRouteIconCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.RouteRouteIconCompartmentCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == KragsteinMethod.diagram.providers.KragsteinMethodElementTypes.EmptyConnector_3015) {
				return this;
			}
