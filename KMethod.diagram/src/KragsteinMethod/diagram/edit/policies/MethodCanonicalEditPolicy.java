 ...
 * @generated
 */
public class MethodCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(KragsteinMethod.KragsteinMethodPackage.eINSTANCE
							.getMethod_Header());
			myFeaturesToSynchronize
					.add(KragsteinMethod.KragsteinMethodPackage.eINSTANCE
							.getMethod_Branch());
	...
	protected List getSemanticChildrenList() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getMethod_1000SemanticChildren(viewObject);
		for (KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor d : childDescriptors) {
	...
	protected boolean isOrphaned(Collection<EObject> semanticChildren,
			final View view) {
		if (isShortcut(view)) {
			return KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = KragsteinMethod.diagram.part.KragsteinMethodVisualIDRegistry
				.getVisualID(view);
		return visualID == KragsteinMethod.diagram.edit.parts.HeaderEditPart.VISUAL_ID
				|| visualID == KragsteinMethod.diagram.edit.parts.BranchEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getMethod_1000SemanticChildren((View) getHost().getModel());
		LinkedList<View> orphaned = new LinkedList<View>();
		// we care to check only views we recognize as ours and not shortcuts
		LinkedList<View> knownViewChildren = new LinkedList<View>();
		for (View v : getViewChildren()) {
			if (isShortcut(v)) {
				if (KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
		...
		for (Iterator<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor next = descriptorsIterator
					.next();
			String hint = KragsteinMethod.diagram.part.KragsteinMethodVisualIDRegistry
		...
		for (KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor next : childDescriptors) {
			String hint = KragsteinMethod.diagram.part.KragsteinMethodVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = KragsteinMethod.diagram.part.KragsteinMethodVisualIDRegistry
			...
			for (Iterator<KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor> collectAllLinks(
		...
		case KragsteinMethod.diagram.edit.parts.MethodEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getMethod_1000ContainedLinks(view));
			}
		...
		case KragsteinMethod.diagram.edit.parts.HeaderEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getHeader_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.BranchEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getBranch_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.RouteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getRoute_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinMethod.diagram.edit.parts.QuestionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getQuestion_3003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinMethod.diagram.edit.parts.ChoiceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getChoice_3004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinMethod.diagram.edit.parts.HeadlineEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getHeadline_3006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.AdressEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getAdress_3007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.InsertionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getInsertion_3008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.ShelfEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getShelf_3009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.BeginLoopEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getBeginLoop_3010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.EndLoopEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getEndLoop_3011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.OutputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getOutput_3012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.InputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getInput_3013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.LoopArrowEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getLoopArrow_3014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinMethod.diagram.edit.parts.EndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getEnd_3016ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.BranchConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getBranchConnection_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.BranchConnection2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getBranchConnection_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinMethod.diagram.edit.parts.CaseConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getCaseConnection_4005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinMethod.diagram.edit.parts.CaseConnection2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
						.getCaseConnection_4006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (KragsteinMethod.diagram.part.KragsteinMethodLinkDescriptor nextLinkDescriptor : linkDescriptors) {
