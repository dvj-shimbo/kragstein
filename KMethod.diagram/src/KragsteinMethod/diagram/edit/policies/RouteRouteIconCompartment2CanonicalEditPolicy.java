 ...
 * @generated
 */
public class RouteRouteIconCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7004SemanticChildren((View) getHost()
						.getModel());
