 ...
 * @generated
 */
public class RouteRouteIconCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return KragsteinMethod.KragsteinMethodPackage.eINSTANCE.getRoute_Icon();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7007SemanticChildren((View) getHost()
						.getModel());
