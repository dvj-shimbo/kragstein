 ...
 * @generated
 */
public class RouteRouteIconCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<KragsteinMethod.diagram.part.KragsteinMethodNodeDescriptor> childDescriptors = KragsteinMethod.diagram.part.KragsteinMethodDiagramUpdater
				.getRouteRouteIconCompartment_7002SemanticChildren((View) getHost()
						.getModel());
