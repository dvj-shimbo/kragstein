 ...
 * @generated
 */
public class KragsteinMethodModelingAssistantProviderOfInsertionEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((KragsteinMethod.diagram.edit.parts.InsertionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			KragsteinMethod.diagram.edit.parts.InsertionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(KragsteinMethod.diagram.edit.parts.InsertionEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((KragsteinMethod.diagram.edit.parts.InsertionEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			KragsteinMethod.diagram.edit.parts.InsertionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(2);
		types.add(KragsteinMethod.diagram.providers.KragsteinMethodElementTypes.IconConnection_4003);
		types.add(KragsteinMethod.diagram.providers.KragsteinMethodElementTypes.IconConnection_4004);
		return types;
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(KragsteinMethod.diagram.edit.parts.InsertionEditPart) targetEditPart,
				relationshipType);
	}
