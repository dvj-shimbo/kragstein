 ...
 * @generated
 */
public class KragsteinMethodModelingAssistantProviderOfQuestionEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((KragsteinMethod.diagram.edit.parts.QuestionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			KragsteinMethod.diagram.edit.parts.QuestionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(KragsteinMethod.diagram.edit.parts.QuestionEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((KragsteinMethod.diagram.edit.parts.QuestionEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			KragsteinMethod.diagram.edit.parts.QuestionEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(KragsteinMethod.diagram.providers.KragsteinMethodElementTypes.IconConnection_4003);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(KragsteinMethod.diagram.edit.parts.QuestionEditPart) targetEditPart,
				relationshipType);
	}
