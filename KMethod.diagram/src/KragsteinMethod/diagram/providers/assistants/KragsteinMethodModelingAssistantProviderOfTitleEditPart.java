 ...
 * @generated
 */
public class KragsteinMethodModelingAssistantProviderOfTitleEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((KragsteinMethod.diagram.edit.parts.TitleEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			KragsteinMethod.diagram.edit.parts.TitleEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(KragsteinMethod.diagram.edit.parts.TitleEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((KragsteinMethod.diagram.edit.parts.TitleEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			KragsteinMethod.diagram.edit.parts.TitleEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(KragsteinMethod.diagram.providers.KragsteinMethodElementTypes.Connection_4006);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(KragsteinMethod.diagram.edit.parts.TitleEditPart) targetEditPart,
				relationshipType);
	}
