...
public class AddHeaderFeature extends AbstractAddShapeFeature {
	...
	public AddHeaderFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		layoutService.setLocationAndSize(rect, 10, 10, 100, 40);
		rect.setFilled(true);
		link(shape, header);	
		return shape;
	}
