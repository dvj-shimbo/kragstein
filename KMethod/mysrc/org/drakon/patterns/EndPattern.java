...
public class EndPattern extends IdPattern implements IPattern {
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		return mainBusinessObject instanceof End;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		End act = KragsteinMethodFactory.eINSTANCE.createEnd();
	...
	public PictogramElement doAdd(IAddContext context) {
		...
		End param = (End) context.getNewObject();
		...
		rect.setLineWidth(1);
		Text text = createService.createText(rect, "Конец");
