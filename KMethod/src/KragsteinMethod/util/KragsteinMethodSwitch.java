 ...
 * @generated
 */
public class KragsteinMethodSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KragsteinMethodPackage.METHOD: {
			...
			case KragsteinMethodPackage.ICON: {
				Icon icon = (Icon)theEObject;
				T result = caseIcon(icon);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KragsteinMethodPackage.ACTION: {
			...
			case KragsteinMethodPackage.QUESTION: {
			...
			case KragsteinMethodPackage.CHOICE: {
			...
			case KragsteinMethodPackage.HEADLINE: {
			...
			case KragsteinMethodPackage.ADRESS: {
			...
			case KragsteinMethodPackage.INSERTION: {
			...
			case KragsteinMethodPackage.SHELF: {
			...
			case KragsteinMethodPackage.BEGIN_LOOP: {
			...
			case KragsteinMethodPackage.END_LOOP: {
			...
			case KragsteinMethodPackage.OUTPUT: {
