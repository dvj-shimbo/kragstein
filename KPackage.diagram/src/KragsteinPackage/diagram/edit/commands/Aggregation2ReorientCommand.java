 ...
 * @generated
 */
public class Aggregation2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Aggregation2ReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof KragsteinPackage.Aggregation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return KragsteinPackage.diagram.edit.policies.KragsteinPackageBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistAggregation_4008(container,
	 ...
	 * @generated
	 */
	protected KragsteinPackage.Aggregation getLink() {
		return (KragsteinPackage.Aggregation) getElementToEdit();
	}
