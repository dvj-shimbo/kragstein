...
public class Association2ReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof KragsteinPackage.Association) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return KragsteinPackage.diagram.edit.policies.KragsteinPackageBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistAssociation_4006(container,
	 ...
	 * @generated
	 */
	protected KragsteinPackage.Association getLink() {
		return (KragsteinPackage.Association) getElementToEdit();
	}
