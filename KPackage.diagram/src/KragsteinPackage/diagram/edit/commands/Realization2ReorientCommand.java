 ...
 * @generated
 */
public class Realization2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Realization2ReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof KragsteinPackage.Realization) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return KragsteinPackage.diagram.edit.policies.KragsteinPackageBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRealization_4004(container,
	 ...
	 * @generated
	 */
	protected KragsteinPackage.Realization getLink() {
		return (KragsteinPackage.Realization) getElementToEdit();
	}
