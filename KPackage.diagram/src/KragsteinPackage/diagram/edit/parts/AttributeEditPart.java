...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinPackage.diagram.edit.policies.AttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinPackage.diagram.edit.parts.AttributeNameEditPart) {
			((KragsteinPackage.diagram.edit.parts.AttributeNameEditPart) childEditPart)
