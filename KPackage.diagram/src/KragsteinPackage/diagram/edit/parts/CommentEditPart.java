...
public class CommentEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinPackage.diagram.edit.policies.CommentItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinPackage.diagram.edit.parts.CommentNameEditPart) {
			((KragsteinPackage.diagram.edit.parts.CommentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCommentLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class CommentFigure extends RoundedRectangle {
