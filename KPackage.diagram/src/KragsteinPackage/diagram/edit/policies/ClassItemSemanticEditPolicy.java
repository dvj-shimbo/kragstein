...
public class ClassItemSemanticEditPolicy
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Generalization2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Association2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Aggregation2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Composition2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Dependency2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(incomingLink) == KragsteinPackage.diagram.edit.parts.Link2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Generalization2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Association2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Aggregation2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Composition2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Dependency2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
			...
			if (KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getVisualID(outgoingLink) == KragsteinPackage.diagram.edit.parts.Link2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Generalization_4002 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Generalization2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Realization_4004 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Realization2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Association_4006 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Association2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Aggregation_4008 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Aggregation2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Composition_4010 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Composition2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Dependency_4012 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Dependency2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Link_4014 == req
				.getElementType()) {
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Link2CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(
		...
		case KragsteinPackage.diagram.edit.parts.Generalization2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Generalization2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Realization2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Association2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Association2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Aggregation2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Aggregation2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Composition2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Composition2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Dependency2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Dependency2ReorientCommand(
					req));
		...
		case KragsteinPackage.diagram.edit.parts.Link2EditPart.VISUAL_ID:
			return getGEFWrapper(new KragsteinPackage.diagram.edit.commands.Link2ReorientCommand(
					req));
		}
