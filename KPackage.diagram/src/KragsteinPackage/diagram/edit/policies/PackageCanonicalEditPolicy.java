...
public class PackageCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return KragsteinPackage.KragsteinPackagePackage.eINSTANCE
				.getPackage_Unit();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor> childDescriptors = KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
				.getPackage_1000SemanticChildren(viewObject);
		for (KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor d : childDescriptors) {
	...
	protected boolean isOrphaned(Collection<EObject> semanticChildren,
			final View view) {
		if (isShortcut(view)) {
			return KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
				.getVisualID(view);
		return visualID == KragsteinPackage.diagram.edit.parts.NoteEditPart.VISUAL_ID
				|| visualID == KragsteinPackage.diagram.edit.parts.ClassEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		for (View v : getViewChildren()) {
			if (isShortcut(v)) {
				if (KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
		...
		for (Iterator<KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor next = descriptorsIterator
					.next();
			String hint = KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
		...
		for (KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor next : childDescriptors) {
			String hint = KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
			...
			for (Iterator<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> collectAllLinks(
		...
		case KragsteinPackage.diagram.edit.parts.NoteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getNote_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinPackage.diagram.edit.parts.RealizationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getRealization_4003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getRealization_4004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case KragsteinPackage.diagram.edit.parts.AggregationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getAggregation_4007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.Aggregation2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getAggregation_4008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.CompositionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getComposition_4009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.Composition2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getComposition_4010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.DependencyEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getDependency_4011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.Dependency2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getDependency_4012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.LinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getLink_4013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case KragsteinPackage.diagram.edit.parts.Link2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(KragsteinPackage.diagram.part.KragsteinPackageDiagramUpdater
						.getLink_4014ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor nextLinkDescriptor : linkDescriptors) {
