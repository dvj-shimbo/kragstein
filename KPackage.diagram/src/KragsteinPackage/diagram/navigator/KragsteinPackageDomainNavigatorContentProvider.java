 ...
 * @generated
 */
public class KragsteinPackageDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public KragsteinPackageDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof KragsteinPackage.diagram.navigator.KragsteinPackageDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((KragsteinPackage.diagram.navigator.KragsteinPackageDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new KragsteinPackage.diagram.navigator.KragsteinPackageDomainNavigatorItem(
