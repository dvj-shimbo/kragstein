...
public class KragsteinPackageNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case KragsteinPackage.diagram.edit.parts.ImportedClassEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?KragsteinPackage.ecore?ImportedClass", KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.ImportedClass_3004); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case KragsteinPackage.diagram.edit.parts.ImportedClassEditPart.VISUAL_ID:
			return getImportedClass_3004Text(view);
		case KragsteinPackage.diagram.edit.parts.GeneralizationEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getImportedClass_3004Text(View view) {
		IParser parser = KragsteinPackage.diagram.providers.KragsteinPackageParserProvider
				.getParser(
