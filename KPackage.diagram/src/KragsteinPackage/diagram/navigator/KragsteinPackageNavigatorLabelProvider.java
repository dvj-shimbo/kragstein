...
public class KragsteinPackageNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?KragsteinPackage.ecore?Comment", KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.Comment_2001); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID:
			return getComment_2001Text(view);
		case KragsteinPackage.diagram.edit.parts.ClassEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getComment_2001Text(View view) {
