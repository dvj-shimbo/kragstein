...
public class KragsteinPackageDiagramUpdater {
	...
	public static List<KragsteinPackage.diagram.part.KragsteinPackageNodeDescriptor> getPackage_1000SemanticChildren(
		...
		for (Iterator<?> it = modelElement.getUnit().iterator(); it.hasNext();) {
			...
			if (visualID == KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID) {
	 ...
	 * @generated
	 */
	public static List<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> getComment_2001ContainedLinks(
			View view) {
		KragsteinPackage.Comment modelElement = (KragsteinPackage.Comment) view
				.getElement();
	 ...
	 * @generated
	 */
	public static List<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> getComment_2001IncomingLinks(
			View view) {
		KragsteinPackage.Comment modelElement = (KragsteinPackage.Comment) view
				.getElement();
	 ...
	 * @generated
	 */
	public static List<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> getComment_2001OutgoingLinks(
			View view) {
		KragsteinPackage.Comment modelElement = (KragsteinPackage.Comment) view
				.getElement();
		LinkedList<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor> result = new LinkedList<KragsteinPackage.diagram.part.KragsteinPackageLinkDescriptor>();
