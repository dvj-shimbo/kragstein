...
public class KragsteinPackagePaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		...
		paletteContainer.add(createImportedPackage3CreationTool());
	 ...
	 * @generated
	 */
	private ToolEntry createImportedPackage3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(
				KragsteinPackage.diagram.part.Messages.ImportedPackage3CreationTool_title,
				KragsteinPackage.diagram.part.Messages.ImportedPackage3CreationTool_desc,
				Collections
						.singletonList(KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.ImportedPackage_3003));
		entry.setId("createImportedPackage3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(KragsteinPackage.diagram.providers.KragsteinPackageElementTypes
