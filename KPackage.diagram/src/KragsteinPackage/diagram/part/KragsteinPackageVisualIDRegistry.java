...
public class KragsteinPackageVisualIDRegistry {
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case KragsteinPackage.diagram.edit.parts.PackageEditPart.VISUAL_ID:
			if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getComment()
					.isSuperTypeOf(domainElement.eClass())) {
				return KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID;
			}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		switch (containerVisualID) {
		case KragsteinPackage.diagram.edit.parts.PackageEditPart.VISUAL_ID:
			if (KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
		...
		case KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID:
			if (KragsteinPackage.diagram.edit.parts.CommentNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case KragsteinPackage.diagram.edit.parts.ClassEditPart.VISUAL_ID:
			...
			if (KragsteinPackage.diagram.edit.parts.ClassClassImportedPackageCompartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		...
		case KragsteinPackage.diagram.edit.parts.Generalization2EditPart.VISUAL_ID:
			if (KragsteinPackage.diagram.edit.parts.GeneralizationNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID:
			if (KragsteinPackage.diagram.edit.parts.RealizationNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE
				.getGeneralization().isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Generalization2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getRealization()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Realization2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getAssociation()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Association2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getAggregation()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Aggregation2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getComposition()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Composition2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getDependency()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Dependency2EditPart.VISUAL_ID;
		}
		...
		if (KragsteinPackage.KragsteinPackagePackage.eINSTANCE.getLink()
				.isSuperTypeOf(domainElement.eClass())) {
			return KragsteinPackage.diagram.edit.parts.Link2EditPart.VISUAL_ID;
		}
		return -1;
	}
