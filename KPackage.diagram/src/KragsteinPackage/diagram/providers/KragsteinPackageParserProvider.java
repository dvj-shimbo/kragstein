...
public class KragsteinPackageParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser importedPackageName_5004Parser;

	/**
	 * @generated
	 */
	private IParser getImportedPackageName_5004Parser() {
		if (importedPackageName_5004Parser == null) {
			EAttribute[] features = new EAttribute[] { KragsteinPackage.KragsteinPackagePackage.eINSTANCE
					.getImportedPackage_Name() };
			KragsteinPackage.diagram.parsers.MessageFormatParser parser = new KragsteinPackage.diagram.parsers.MessageFormatParser(
					features);
			importedPackageName_5004Parser = parser;
		}
		return importedPackageName_5004Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case KragsteinPackage.diagram.edit.parts.ImportedPackageNameEditPart.VISUAL_ID:
			return getImportedPackageName_5004Parser();
