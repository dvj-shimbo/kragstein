...
public class KragsteinPackageViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case KragsteinPackage.diagram.edit.parts.CommentEditPart.VISUAL_ID:
			return createComment_2001(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createComment_2001(EObject domainElement, View containerView,
		...
		Node label5001 = createLabel(
				node,
				KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
						.getType(KragsteinPackage.diagram.edit.parts.CommentNameEditPart.VISUAL_ID));
		return node;
	}
