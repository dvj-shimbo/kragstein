...
public class KragsteinPackageViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return KragsteinPackage.diagram.edit.parts.NoteEditPart.VISUAL_ID == visualID
				...
				|| KragsteinPackage.diagram.edit.parts.ImportedClassEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case KragsteinPackage.diagram.edit.parts.MethodEditPart.VISUAL_ID:
			return createMethod_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case KragsteinPackage.diagram.edit.parts.ImportedClassEditPart.VISUAL_ID:
			return createImportedClass_3004(domainElement, containerView,
	...
	public Node createClass_2002(EObject domainElement, View containerView,
		...
		createCompartment(
				node,
				KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
						.getType(KragsteinPackage.diagram.edit.parts.ClassClassImportedClassCompartmentEditPart.VISUAL_ID),
				true, false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createImportedClass_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
				.getType(KragsteinPackage.diagram.edit.parts.ImportedClassEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5006 = createLabel(
				node,
				KragsteinPackage.diagram.part.KragsteinPackageVisualIDRegistry
						.getType(KragsteinPackage.diagram.edit.parts.ImportedClassNameEditPart.VISUAL_ID));
		return node;
	}
