 ...
 *   <li>{@link KragsteinPackage.impl.AssociationImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssociationImpl extends EObjectImpl implements Association {
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.ASSOCIATION__TARGET_CLASS, oldTargetClass, targetClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case KragsteinPackagePackage.ASSOCIATION__TARGET_CLASS:
