 ...
 *   <li>{@link KragsteinPackage.impl.GeneralizationImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends EObjectImpl implements Generalization {
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.GENERALIZATION__TARGET_CLASS, oldTargetClass, targetClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case KragsteinPackagePackage.GENERALIZATION__TARGET_CLASS:
