 ...
 * <ul>
 *   <li>{@link KragsteinPackage.impl.RealizationImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link KragsteinPackage.impl.RealizationImpl#getSource <em>Source</em>}</li>
...
public class RealizationImpl extends EObjectImpl implements Realization {
	...
	protected EClass eStaticClass() {
		return KragsteinPackagePackage.Literals.REALIZATION;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KragsteinPackagePackage.REALIZATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(KragsteinPackage.Class newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.REALIZATION__TARGET, oldTarget, target));
	}
	...
	public KragsteinPackage.Class getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KragsteinPackagePackage.REALIZATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(KragsteinPackage.Class newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.REALIZATION__SOURCE, oldSource, source));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.REALIZATION__NAME, oldName, name));
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.REALIZATION__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackagePackage.REALIZATION__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KragsteinPackagePackage.REALIZATION__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case KragsteinPackagePackage.REALIZATION__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case KragsteinPackagePackage.REALIZATION__NAME:
				return getName();
			case KragsteinPackagePackage.REALIZATION__LOWER_BOUND:
