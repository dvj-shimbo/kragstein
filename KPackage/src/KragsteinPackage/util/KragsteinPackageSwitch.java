 ...
 * @generated
 */
public class KragsteinPackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KragsteinPackagePackage.PACKAGE: {
				KragsteinPackage.Package package_ = (KragsteinPackage.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KragsteinPackagePackage.RELATIONSHIP: {
				Relationship relationship = (Relationship)theEObject;
				T result = caseRelationship(relationship);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KragsteinPackagePackage.GENERALIZATION: {
			...
			case KragsteinPackagePackage.REALIZATION: {
			...
			case KragsteinPackagePackage.ASSOCIATION: {
			...
			case KragsteinPackagePackage.AGGREGATION: {
			...
			case KragsteinPackagePackage.COMPOSITION: {
			...
			case KragsteinPackagePackage.DEPENDENCY: {
			...
			case KragsteinPackagePackage.CLASS: {
				KragsteinPackage.Class class_ = (KragsteinPackage.Class)theEObject;
			...
			case KragsteinPackagePackage.ATTRIBUTE: {
			...
			case KragsteinPackagePackage.UNIT: {
	 ...
	 * @generated
	 */
	public T casePackage(KragsteinPackage.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(KragsteinPackage.Class object) {
		return null;
	}
