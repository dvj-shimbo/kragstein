...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinProject.diagram.edit.policies.ClassItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.ClassNameEditPart) {
			((KragsteinProject.diagram.edit.parts.ClassNameEditPart) childEditPart)
