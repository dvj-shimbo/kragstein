...
public class Package2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinProject.diagram.edit.policies.Package2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.PackageName2EditPart) {
			((KragsteinProject.diagram.edit.parts.PackageName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePackageLabelFigure());
			return true;
		}
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.PackagePackagePackageCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getPackagePackageCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((KragsteinProject.diagram.edit.parts.PackagePackagePackageCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.PackagePackageClassCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getPackageClassCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((KragsteinProject.diagram.edit.parts.PackagePackageClassCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.PackagePackagePackageCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getPackagePackageCompartmentFigure();
			pane.remove(((KragsteinProject.diagram.edit.parts.PackagePackagePackageCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof KragsteinProject.diagram.edit.parts.PackagePackageClassCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getPackageClassCompartmentFigure();
			pane.remove(((KragsteinProject.diagram.edit.parts.PackagePackageClassCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof KragsteinProject.diagram.edit.parts.PackagePackagePackageCompartment2EditPart) {
			return getPrimaryShape().getPackagePackageCompartmentFigure();
		}
		if (editPart instanceof KragsteinProject.diagram.edit.parts.PackagePackageClassCompartment2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(KragsteinProject.diagram.part.KragsteinProjectVisualIDRegistry
