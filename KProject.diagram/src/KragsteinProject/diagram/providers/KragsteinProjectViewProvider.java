 ...
 * @generated
 */
public class KragsteinProjectViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(KragsteinProject.diagram.edit.parts.ProjectEditPart.MODEL_ID);
	...
	private void stampShortcut(View containerView, Node target) {
		if (!KragsteinProject.diagram.edit.parts.ProjectEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", KragsteinProject.diagram.edit.parts.ProjectEditPart.MODEL_ID); //$NON-NLS-1$
