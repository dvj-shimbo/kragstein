 ...
 *   <li>{@link KragsteinProject.impl.PackageImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends EObjectImpl implements KragsteinProject.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<KragsteinProject.Class> class_;
	...
	protected EClass eStaticClass() {
		return KragsteinProjectPackage.Literals.PACKAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinProjectPackage.PACKAGE__NAME, oldName, name));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinProjectPackage.PACKAGE__PATH, oldPath, path));
	}
	 ...
	 * @generated
	 */
	public EList<KragsteinProject.Class> getClass_() {
		if (class_ == null) {
			class_ = new EObjectContainmentEList<KragsteinProject.Class>(KragsteinProject.Class.class, this, KragsteinProjectPackage.PACKAGE__CLASS);
		}
		return class_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case KragsteinProjectPackage.PACKAGE__CLASS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KragsteinProjectPackage.PACKAGE__NAME:
				return getName();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case KragsteinProjectPackage.PACKAGE__CLASS:
				getClass_().clear();
				getClass_().addAll((Collection<? extends KragsteinProject.Class>)newValue);
				return;
		}
