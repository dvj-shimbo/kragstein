...
public class ProjectImpl extends EObjectImpl implements Project {
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinProjectPackage.PROJECT__LANG, oldLang, lang));
	}
	...
	public EList<KragsteinProject.Package> getPackage() {
		if (package_ == null) {
			package_ = new EObjectContainmentEList<KragsteinProject.Package>(KragsteinProject.Package.class, this, KragsteinProjectPackage.PROJECT__PACKAGE);
		}
		return package_;
	}
