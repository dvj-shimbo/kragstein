...
public class AggregationCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return KragsteinBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateAggregation_4006(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Aggregation newElement = KragsteinFactory.eINSTANCE.createAggregation();
		getSource().getSourceRelationship().add(newElement);
