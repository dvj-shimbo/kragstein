...
import kragstein.diagram.edit.policies.KragsteinTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CompositionNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				KragsteinVisualIDRegistry
						.getType(kragstein.diagram.edit.parts.CompositionNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CompositionNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new KragsteinTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return KragsteinElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = KragsteinParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					KragsteinEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
