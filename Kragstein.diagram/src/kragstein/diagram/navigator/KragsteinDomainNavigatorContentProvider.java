 ...
 * @generated
 */
public class KragsteinDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public KragsteinDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof KragsteinDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((KragsteinDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new KragsteinDomainNavigatorItem(
