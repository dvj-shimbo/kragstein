 ...
 * @generated
 */
public class KragsteinInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new KragsteinNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				PackageEditPart.MODEL_ID));
		KragsteinDiagramEditorUtil.runWizard(getShell(), wizard,
