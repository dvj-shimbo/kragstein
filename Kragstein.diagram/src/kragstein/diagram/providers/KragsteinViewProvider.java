 ...
 * @generated
 */
public class KragsteinViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = KragsteinVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = KragsteinVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!KragsteinElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != KragsteinVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = KragsteinVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != KragsteinVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = KragsteinVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = KragsteinVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ClassEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (KragsteinVisualIDRegistry.getVisualID(elementTypeHint)) {
		case CompositionEditPart.VISUAL_ID:
			return createComposition_4001(getSemanticElement(semanticAdapter),
		...
		case GeneralizationEditPart.VISUAL_ID:
			return createGeneralization_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AggregationEditPart.VISUAL_ID:
			return createAggregation_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createClass_2001(EObject domainElement, View containerView,
		...
		node.setType(KragsteinVisualIDRegistry.getType(ClassEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createComposition_4001(EObject domainElement,
		...
		edge.setType(KragsteinVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createGeneralization_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAggregation_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
