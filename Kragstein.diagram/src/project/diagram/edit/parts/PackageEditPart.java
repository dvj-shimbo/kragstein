...
import project.diagram.edit.policies.PackageItemSemanticEditPolicy;
...
public class PackageEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ProjectVisualIDRegistry
	...
	public class PackageFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigurePackagePathFigure;
		...
		private void createContents() {
			...
			fFigurePackagePathFigure = new WrappingLabel();

			fFigurePackagePathFigure.setText("<...>");

			this.add(fFigurePackagePathFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePackagePathFigure() {
			return fFigurePackagePathFigure;
		}
