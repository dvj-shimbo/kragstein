...
import project.diagram.edit.policies.ProjectTextSelectionEditPolicy;
...
public class PackageNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ProjectTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return ProjectElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ProjectParserProvider
					.getParser(
							ProjectElementTypes.Package_2001,
							getParserElement(),
							ProjectVisualIDRegistry
									.getType(project.diagram.edit.parts.PackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ProjectEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
