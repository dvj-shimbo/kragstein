 ...
 * @generated
 */
public class ProjectInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ProjectNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ProjectEditPart.MODEL_ID));
		ProjectDiagramEditorUtil.runWizard(getShell(), wizard,
