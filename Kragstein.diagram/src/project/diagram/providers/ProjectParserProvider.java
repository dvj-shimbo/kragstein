...
import project.diagram.parsers.MessageFormatParser;
import project.diagram.part.ProjectVisualIDRegistry;

/**
 * @generated
 */
public class ProjectParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	private IParser getPackageName_5001Parser() {
		if (packageName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { ProjectPackage.eINSTANCE
					.getPackage_Name() };
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(ProjectVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(ProjectVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (ProjectElementTypes.getElement(hint) == null) {
				return false;
			}
