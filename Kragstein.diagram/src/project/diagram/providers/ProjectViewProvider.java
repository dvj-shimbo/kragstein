 ...
 * @generated
 */
public class ProjectViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ProjectVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ProjectVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ProjectElementTypes.isKnownElementType(elementType)
				...
				if (!ProjectEditPart.MODEL_ID.equals(ProjectVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ProjectVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ProjectVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ProjectVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ProjectVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case PackageEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ProjectVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createPackage_2001(EObject domainElement, View containerView,
		...
		node.setType(ProjectVisualIDRegistry.getType(PackageEditPart.VISUAL_ID));
