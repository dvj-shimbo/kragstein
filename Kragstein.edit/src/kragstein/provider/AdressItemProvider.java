...
/**
 * This is the item provider adapter for a {@link kragstein.Adress} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdressItemProvider extends IconItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Adress_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Adress_name_feature", "_UI_Adress_type"),
				 KragsteinPackage.Literals.ADRESS__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsLoopPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Adress_isLoop_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Adress_isLoop_feature", "_UI_Adress_type"),
				 KragsteinPackage.Literals.ADRESS__IS_LOOP,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Adress)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Adress_type") :
			getString("_UI_Adress_type") + " " + label;
	}
