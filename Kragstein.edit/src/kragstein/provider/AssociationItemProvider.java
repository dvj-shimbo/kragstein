...
/**
 * This is the item provider adapter for a {@link kragstein.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addTargetClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_targetClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_targetClass_feature", "_UI_Relationship_type"),
				 KragsteinPackage.Literals.RELATIONSHIP__TARGET_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
