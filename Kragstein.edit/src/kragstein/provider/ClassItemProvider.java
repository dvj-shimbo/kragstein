...
public class ClassItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSupplierElementPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KragsteinPackage.Literals.CLASS__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KragsteinPackage.Literals.CLASS__SUPER_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Supplier Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSupplierElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_supplierElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_supplierElement_feature", "_UI_Class_type"),
				 KragsteinPackage.Literals.CLASS__SUPPLIER_ELEMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KragsteinPackage.Literals.CLASS__ATTRIBUTE);
			childrenFeatures.add(KragsteinPackage.Literals.CLASS__METHOD);
			childrenFeatures.add(KragsteinPackage.Literals.CLASS__COMMENT);
			...
			childrenFeatures.add(KragsteinPackage.Literals.CLASS__IMPORTED_PACKAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.CLASS__ATTRIBUTE,
				 KragsteinFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.CLASS__METHOD,
				 KragsteinFactory.eINSTANCE.createMethod()));

		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.CLASS__COMMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.CLASS__IMPORTED_PACKAGE,
