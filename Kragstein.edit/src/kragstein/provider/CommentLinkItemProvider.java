...
/**
 * This is the item provider adapter for a {@link kragstein.CommentLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentLinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_CommentLink_source_feature", "_UI_CommentLink_type"),
				 KragsteinPackage.Literals.COMMENT_LINK__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_CommentLink_target_feature", "_UI_CommentLink_type"),
				 KragsteinPackage.Literals.COMMENT_LINK__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_CommentLink_type");
	}
