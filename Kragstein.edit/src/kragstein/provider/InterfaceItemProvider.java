...
/**
 * This is the item provider adapter for a {@link kragstein.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends UnitItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KragsteinPackage.Literals.INTERFACE__METHODS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Interface.class)) {
			case KragsteinPackage.INTERFACE__METHODS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.INTERFACE__METHODS,
				 KragsteinFactory.eINSTANCE.createInterfaceMethod()));
	}
