...
/**
 * This is the item provider adapter for a {@link kragstein.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KragsteinPackage.Literals.UNIT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unit_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unit_visibility_feature", "_UI_Unit_type"),
				 KragsteinPackage.Literals.UNIT__VISIBILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KragsteinPackage.Literals.UNIT__SOURCE_CONNECTION,
