...
public class ProjectActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(ProjectEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(ProjectEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ProjectEditorPlugin.INSTANCE.getString("_UI_ProjectEditor_menu"), "projectMenuID");
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ProjectEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
