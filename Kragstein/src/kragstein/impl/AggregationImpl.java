 ...
 *   <li>{@link kragstein.impl.AggregationImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AggregationImpl extends MinimalEObjectImpl.Container implements Aggregation {
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.AGGREGATION__TARGET_CLASS, oldTargetClass, targetClass));
	}
