 ...
 *   <li>{@link kragstein.impl.CaseConnectionImpl#getTargetCase <em>Target Case</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CaseConnectionImpl extends MinimalEObjectImpl.Container implements CaseConnection {
	...
	public void setTargetCase(String newTargetCase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.CASE_CONNECTION__TARGET_CASE, oldTargetCase, targetCase));
	}
