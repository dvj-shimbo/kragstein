 ...
 *   <li>{@link kragstein.impl.GeneralizationImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends MinimalEObjectImpl.Container implements Generalization {
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.GENERALIZATION__TARGET_CLASS, oldTargetClass, targetClass));
	}
