 ...
 *   <li>{@link kragstein.impl.IconConnectionImpl#getTargetIcon <em>Target Icon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IconConnectionImpl extends MinimalEObjectImpl.Container implements IconConnection {
	...
	public void setTargetIcon(String newTargetIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.ICON_CONNECTION__TARGET_ICON, oldTargetIcon, targetIcon));
	}
