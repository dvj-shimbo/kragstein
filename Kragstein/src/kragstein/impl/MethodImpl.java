 ...
 * <ul>
 *   <li>{@link kragstein.impl.MethodImpl#getParameter <em>Parameter</em>}</li>
 ...
 *   <li>{@link kragstein.impl.MethodImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link kragstein.impl.MethodImpl#getBranch <em>Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodImpl extends MinimalEObjectImpl.Container implements Method {
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, KragsteinPackage.METHOD__PARAMETER);
		}
		return parameter;
	}
	...
	public NotificationChain basicSetHeader(Header newHeader, NotificationChain msgs) {
		...
		header = newHeader;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, KragsteinPackage.METHOD__HEADER, oldHeader, newHeader);
	...
	public void setHeader(Header newHeader) {
		if (newHeader != header) {
			...
			if (header != null)
				msgs = ((InternalEObject)header).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - KragsteinPackage.METHOD__HEADER, null, msgs);
			if (newHeader != null)
				msgs = ((InternalEObject)newHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - KragsteinPackage.METHOD__HEADER, null, msgs);
			msgs = basicSetHeader(newHeader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.METHOD__HEADER, newHeader, newHeader));
	}
	...
	public EList<Branch> getBranch() {
		if (branch == null) {
			branch = new EObjectContainmentEList<Branch>(Branch.class, this, KragsteinPackage.METHOD__BRANCH);
		}
		return branch;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KragsteinPackage.METHOD__PARAMETER:
				return ((InternalEList<?>)getParameter()).basicRemove(otherEnd, msgs);
			case KragsteinPackage.METHOD__HEADER:
				return basicSetHeader(null, msgs);
			case KragsteinPackage.METHOD__BRANCH:
