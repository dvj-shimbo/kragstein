 ...
 *   <li>{@link kragstein.impl.RealizationImpl#getTargetClass <em>Target Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealizationImpl extends MinimalEObjectImpl.Container implements Realization {
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KragsteinPackage.REALIZATION__TARGET_CLASS, oldTargetClass, targetClass));
	}
