 ...
 * @generated
 */
public class BeginLoopNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BeginLoopNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.KragsteinMethodTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = KragsteinMethod.diagram.providers.KragsteinMethodParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					KragsteinMethod.diagram.edit.parts.KragsteinMethodEditPartFactory
