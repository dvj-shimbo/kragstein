...
public class InputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.InputItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinMethod.diagram.edit.parts.InputNameEditPart) {
			((KragsteinMethod.diagram.edit.parts.InputNameEditPart) childEditPart)
