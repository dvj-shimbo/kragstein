...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinMethod.diagram.edit.policies.OutputItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KragsteinMethod.diagram.edit.parts.OutputNameEditPart) {
			((KragsteinMethod.diagram.edit.parts.OutputNameEditPart) childEditPart)
