 ...
 * @generated
 */
public class KragsteinMethodDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public KragsteinMethodDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof KragsteinMethod.diagram.navigator.KragsteinMethodDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((KragsteinMethod.diagram.navigator.KragsteinMethodDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new KragsteinMethod.diagram.navigator.KragsteinMethodDomainNavigatorItem(
