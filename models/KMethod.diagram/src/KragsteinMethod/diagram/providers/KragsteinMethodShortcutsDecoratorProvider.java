 ...
 * @generated
 */
public class KragsteinMethodShortcutsDecoratorProvider extends AbstractProvider
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = KragsteinMethod.diagram.part.KragsteinMethodDiagramEditorPlugin
