...
public class GeneralizationReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof KragsteinPackage.Generalization) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return KragsteinPackage.diagram.edit.policies.KragsteinPackageBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistGeneralization_4001(container,
	 ...
	 * @generated
	 */
	protected KragsteinPackage.Generalization getLink() {
		return (KragsteinPackage.Generalization) getElementToEdit();
	}
