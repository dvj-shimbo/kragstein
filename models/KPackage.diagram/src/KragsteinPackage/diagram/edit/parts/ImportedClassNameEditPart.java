 ...
 * @generated
 */
public class ImportedClassNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ImportedClassNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinPackage.diagram.edit.policies.KragsteinPackageTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = KragsteinPackage.diagram.providers.KragsteinPackageParserProvider
					.getParser(
							KragsteinPackage.diagram.providers.KragsteinPackageElementTypes.ImportedClass_3004,
							getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					KragsteinPackage.diagram.edit.parts.KragsteinPackageEditPartFactory
