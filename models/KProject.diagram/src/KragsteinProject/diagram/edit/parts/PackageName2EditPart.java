...
public class PackageName2EditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new KragsteinProject.diagram.edit.policies.KragsteinProjectTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return KragsteinProject.diagram.providers.KragsteinProjectElementTypes
	...
	public IParser getParser() {
		if (parser == null) {
			parser = KragsteinProject.diagram.providers.KragsteinProjectParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					KragsteinProject.diagram.edit.parts.KragsteinProjectEditPartFactory
