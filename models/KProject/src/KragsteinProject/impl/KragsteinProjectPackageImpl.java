 ...
 * @generated
 */
public class KragsteinProjectPackageImpl extends EPackageImpl implements KragsteinProjectPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see KragsteinProject.KragsteinProjectPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private KragsteinProjectPackageImpl() {
		super(eNS_URI, KragsteinProjectFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link KragsteinProjectPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static KragsteinProjectPackage init() {
		if (isInited) return (KragsteinProjectPackage)EPackage.Registry.INSTANCE.getEPackage(KragsteinProjectPackage.eNS_URI);

		// Obtain or create and register package
		KragsteinProjectPackageImpl theKragsteinProjectPackage = (KragsteinProjectPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof KragsteinProjectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new KragsteinProjectPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theKragsteinProjectPackage.createPackageContents();

		// Initialize created meta-data
		theKragsteinProjectPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theKragsteinProjectPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(KragsteinProjectPackage.eNS_URI, theKragsteinProjectPackage);
		return theKragsteinProjectPackage;
	}
